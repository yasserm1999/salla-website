...
const team = [
  {
    name: "Kumar",
    role: "Senior Garment Care Specialist",
    experience: "Years of Experience",
    skills: ["Fabric Inspection", "Premium Garment Care", "Professional Finishing"],
    image: "/team-kumar.jpg",
  },
  {
    name: "Sunny",
    role: "Cleaning Process Specialist",
    experience: "Years of Experience",
    skills: ["Wet Cleaning", "Dry Cleaning Support", "Garment Handling"],
    image: "/team-sunny.jpg",
  },
  {
    name: "Sonu",
    role: "Finishing & Pressing Specialist",
    experience: "Years of Experience",
    skills: ["Pressing", "Detail Finishing", "Quality Care"],
    image: "/team-sonu.jpg",
  },
  {
    name: "Sanju",
    ...
    experience: "Years of Experience",
    skills: ["Final Check", "Order Accuracy", "Customer Care"],
      ...
      <div className="mx-auto max-w-7xl">
        <div className="text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-[#546d83] md:text-lg md:leading-8">
            The people behind Salla&apos;s quality standards, professional care,
        ...
        <div className="mt-10 grid gap-4 rounded-[30px] bg-[#26364d]/95 p-5 text-white shadow-2xl md:grid-cols-3 md:p-8">
          <Stat icon={<Users />} title="4 Team Members" />
          <Stat icon={<Award />} title="Professional Care" />
          <Stat icon={<Sparkles />} title="Quality Focused" />
        </div>
